...
export const INVALID_REGISTER_REQUEST_MESSAGE = 'Invalid registration!';
export const INVALID_TRIP_REQUEST_MESSAGE = 'Invalid trip!';
export const TRIP_EXISTS_ERROR_MESSAGE = 'Trip exists!';
